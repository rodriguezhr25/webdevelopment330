...
export default class Quake {
  constructor() {
    this.baseUrl =
    //  'https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2017-01-01&endtime=2020-03-02';
  ...
  async getEarthQuakesByRadius(position, radius = 100, startDate, endDate) {
